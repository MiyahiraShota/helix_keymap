...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|      | Alt  |      | EISU |LOWER |GuiSpc|Space |RAISE | KANA | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
  ...
  [_GAME] = LAYOUT( \
      ...
      _______, KC_LALT, KC_PSCR, _______, _______, _______,  KC_SPC,  _______, _______, _______, _______, _______, _______, _______ \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_NUBS, \
