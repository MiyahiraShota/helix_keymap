...
#define L_EISU LT(_LOWER, KC_LANG2)
#define R_KANA LT(_RAISE, KC_LANG1)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|      | Alt  |      |      |L_EISU|GuiSpc|Space |R_KANA|      | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  _______, KC_LALT, _______, _______, L_EISU,  GUI_SPC, KC_SPC,  R_KANA,  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
